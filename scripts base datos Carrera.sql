USE [Carrera]
GO
/****** Object:  Table [dbo].[Asignaturas]    Script Date: 06/09/2023 23:26:08 ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [dbo].[Carreras]    Script Date: 06/09/2023 23:26:08 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Detalle_Carrera]    Script Date: 06/09/2023 23:26:08 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
INSERT [dbo].[Detalle_Carrera] ([id_Carrera], [id_DetCar], [AnioCursado], [Cuatrimestre], [id_asignatura]) VALUES (2, 1, CAST(N'2023-01-09T00:00:00.000' AS DateTime), 1, 1)
GO
INSERT [dbo].[Detalle_Carrera] ([id_Carrera], [id_DetCar], [AnioCursado], [Cuatrimestre], [id_asignatura]) VALUES (2, 2, CAST(N'2023-01-09T00:00:00.000' AS DateTime), 2, 2)
GO
...
GO
/****** Object:  StoredProcedure [dbo].[sp_ConsultarAsignaturas]    Script Date: 06/09/2023 23:26:08 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END;
GO
/****** Object:  StoredProcedure [dbo].[Sp_ProximaCarrera]    Script Date: 06/09/2023 23:26:08 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
